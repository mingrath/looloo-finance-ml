...
- focused tests for as-of joins, feature cutoff, future-split feature invariance, label formula, temporal purge/embargo, SIP proxy selection, cost accounting, position caps, fail-closed behavior, and deterministic replay;
